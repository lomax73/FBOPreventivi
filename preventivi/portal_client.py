...
(clienti/api/internal/). FBOPreventivi non ha più un modello Cliente
locale: salva solo il client_id (UUID) e risolve nome/indirizzo
chiamando questa API in tempo reale — nessuna FK cross-database (vedi
memoria project-multi-app-portal-architecture).
"""
