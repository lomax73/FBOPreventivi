"""
Django settings for fbopreventivi project.
"""
...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-hu)b_8987gx_b95n_p=$(739w9#277oexgvdi_ia8qbn_m&u$l',
)
...
# posto di disattivare del tutto la verifica (RedFlag id 91). Vuoto in locale,
...
ROOT_URLCONF = 'fbopreventivi.urls'
...
WSGI_APPLICATION = 'fbopreventivi.wsgi.application'


# Database — SQLite: volumi piccoli (catalogo prodotti, preventivi, voci).
